...
const PageContent = () => {
  ...
  const TABS = ['profile', 'store', 'security'] as const;
  ...
  return (
    <div className="w-full space-y-6 font-mono text-xs text-zinc-900 antialiased animate-in fade-in duration-300">
      ...
      <div className="border border-zinc-200 bg-white p-5">
          ...
          <p className="text-zinc-500 text-[10px] mt-0.5">Manage creator studio profiles, storefronts, and system settings.</p>
      </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 mb-10 pb-8 border-b border-zinc-150">
              ...
              >
                <div 
                  ...
                  className="w-28 h-28 border border-zinc-250 bg-zinc-50 text-green-700 rounded-none overflow-hidden relative flex items-center justify-center shrink-0 cursor-pointer hover:bg-zinc-150/40 transition-colors"
                ...
                <button 
                  ...
                  className="absolute bottom-0 right-0 bg-zinc-950 text-white p-2 border border-zinc-800 rounded-none cursor-pointer hover:bg-zinc-900 transition-colors"
...
const Page = () => {
  return (
    <Suspense fallback={<div className="font-mono text-xs text-zinc-500 p-5">LOADING CONFIGURATION...</div>}>
      <PageContent />
    </Suspense>
  );
};
