    ...
    return (
        <div className="w-full space-y-6 font-mono text-xs text-zinc-900 antialiased animate-in fade-in duration-300">
            ...
            <div className="border border-zinc-200 bg-white p-5">
                ...
                <h1 className="text-xl font-bold uppercase tracking-wider text-zinc-950 mt-2">Dispute Center</h1>
                ...
                <div className="space-y-3">
                    {filtered.map(dispute => {
                        ...
                        return (
                            <Card 
                                key={dispute.id} 
                                className="p-5 border border-zinc-200 bg-white rounded-none shadow-none hover:bg-zinc-50/60 transition-colors cursor-pointer flex flex-col font-mono text-xs text-zinc-900"
