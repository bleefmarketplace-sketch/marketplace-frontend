                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            {filteredDisputes.map((d) => (
                                ...
                                >
                                    <Card className={`p-6 border-none ring-1 transition-all rounded-[2rem] ${selectedDispute?.id === d.id ? 'ring-emerald-500 bg-emerald-50/20 shadow-xl shadow-emerald-100' : 'ring-gray-100 hover:ring-gray-300 bg-white'
                                        }`}>
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="flex items-center gap-2">
                                                <span className={`px-2 py-1 rounded-md text-[9px] font-black uppercase tracking-widest ${d.status === 'escalated' ? 'bg-red-100 text-red-600' : 'bg-gray-100 text-gray-400'
                                                    }`}>
                                                    {d.status}
                                                </span>
