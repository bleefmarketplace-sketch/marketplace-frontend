      ...
      <div className="max-w-7xl mx-auto px-4 py-16 grid md:grid-cols-5 gap-8">
        ...
        <div className="md:col-span-2">
          <div className="flex items-center gap-2 mb-4 text-white">
            <div className="w-9 h-9 bg-emerald-600 rounded-xl flex items-center justify-center text-white font-black text-lg">B</div>
            <span className="text-xl font-black">Bleefy</span>
          </div>
